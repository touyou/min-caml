...
let rec log e =
  ...
  | If (e1, e2, e3) -> print_string "if "; log e1; print_string " then "; log e2; print_string " else "; log e3
  | Let ((id, typ), e1, e2) -> print_string "let "; Id.log id; print_string ": "; Type.log typ; print_string " = "; log e1; print_string " in "; log e2
  | Var id -> Id.log id
  | LetRec ({ name = (id, typ); args = args; body = e1}, e2) -> print_string "let rec ("; Id.log id; print_string ": "; Type.log typ; print_string ") ("; print_args args; print_string ") = "; log e1; print_string " in "; log e2
