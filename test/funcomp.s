...
bge_cont.897:
	...
	addi	%r4, %r4, 16
	addis	%r8, %r0, (mul_sub.839)@h	# lis
	ori	%r8, %r8, (mul_sub.839)@l
	stw	%r8, 0(%r29)
	stw	%r7, 8(%r29)
	stw	%r6, 4(%r29)
	addi	%r6, %r0, 0	# li
...
compose.444:
	...
	addi	%r4, %r4, 16
	addis	%r7, %r0, (composed.459)@h	# lis
	ori	%r7, %r7, (composed.459)@l
	stw	%r7, 0(%r6)
	stw	%r5, 8(%r6)
	stw	%r2, 4(%r6)
	or	%r6, %r2, %r6	# mr %r2, %r6
...
#	main program starts
	or	%r4, %r2, %r4	# mr %r2, %r4
	addi	%r4, %r4, 8
	addis	%r5, %r0, (dbl.447)@h	# lis
	ori	%r5, %r5, (dbl.447)@l
	stw	%r5, 0(%r2)
	or	%r4, %r5, %r4	# mr %r5, %r4
	addi	%r4, %r4, 8
	addis	%r6, %r0, (inc.449)@h	# lis
	ori	%r6, %r6, (inc.449)@l
	stw	%r6, 0(%r5)
	or	%r4, %r6, %r4	# mr %r6, %r4
	addi	%r4, %r4, 8
	addis	%r7, %r0, (dec.451)@h	# lis
	ori	%r7, %r7, (dec.451)@l
	stw	%r7, 0(%r6)
	stw	%r5, 0(%r3)
	mfspr	%r31, 8	# mflr
