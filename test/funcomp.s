...
bge_cont.876:
	...
	addi	%r4, %r4, 16
	addis	%r8, %r0, (mul_sub.818)@h	# lis
	addi	%r8, %r8, (mul_sub.818)@l
	stw	%r8, 0(%r29)
	stw	%r7, 8(%r29)
	stw	%r6, 4(%r29)
	addi	%r6, %r0, 0	# li
...
compose.433:
	...
	addi	%r4, %r4, 16
	addis	%r7, %r0, (composed.448)@h	# lis
	addi	%r7, %r7, (composed.448)@l
	stw	%r7, 0(%r6)
	stw	%r5, 8(%r6)
	stw	%r2, 4(%r6)
	or	%r6, %r2, %r6	# mr %r2, %r6
...
#	main program starts
	or	%r4, %r2, %r4	# mr %r2, %r4
	addi	%r4, %r4, 8
	addis	%r5, %r0, (dbl.436)@h	# lis
	addi	%r5, %r5, (dbl.436)@l
	stw	%r5, 0(%r2)
	or	%r4, %r5, %r4	# mr %r5, %r4
	addi	%r4, %r4, 8
	addis	%r6, %r0, (inc.438)@h	# lis
	addi	%r6, %r6, (inc.438)@l
	stw	%r6, 0(%r5)
	or	%r4, %r6, %r4	# mr %r6, %r4
	addi	%r4, %r4, 8
	addis	%r7, %r0, (dec.440)@h	# lis
	addi	%r7, %r7, (dec.440)@l
	stw	%r7, 0(%r6)
	stw	%r5, 0(%r3)
	mfspr	%r31, 8	# mflr
	or	%r6, %r5, %r6	# mr %r5, %r6
