...
bge_cont.873:
	...
	addi	%r4, %r4, 16
	addis	%r8, %r0, ha16(mul_sub.825)	# lis
	addi	%r8, %r8, lo16(mul_sub.825)
	stw	%r8, 0(%r29)
	stw	%r7, 8(%r29)
	stw	%r6, 4(%r29)
	addi	%r6, %r0, 0	# li
...
div_sub.791:
	cmpwi	%cr7, %r7, -1
	bc	12, %cr7, beq_else.875
	blr
beq_else.875:
	srw	%r8, %r5, %r7
	cmp	%cr7, %r6, %r8
	bc	4, %cr7, ble_else.876
	addi	%r8, %r0, 1	# li
	slw	%r8, %r8, %r7
	add	%r2, %r8, %r2
	slw	%r8, %r6, %r7
