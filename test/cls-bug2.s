...
bge_cont.886:
	...
	addi	%r4, %r4, 16
	addis	%r8, %r0, (mul_sub.834)@h	# lis
	ori	%r8, %r8, (mul_sub.834)@l
	stw	%r8, 0(%r29)
	stw	%r7, 8(%r29)
	stw	%r6, 4(%r29)
	addi	%r6, %r0, 0	# li
