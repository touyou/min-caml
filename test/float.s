...
kernel_cos.387:
	...
	addi	%r31, %r31, (l.863)@l
	lfs	%f3, 0(%r31)	# float
	addis	%r31, %r0, (l.864)@h	# lis
	addi	%r31, %r31, (l.864)@l
	lfs	%f4, 0(%r31)	# float
	fmul	%f0, %f4, %f0
	fsub	%f0, %f3, %f0
	addis	%r31, %r0, (l.865)@h	# lis
	addi	%r31, %r31, (l.865)@l
	lfs	%f3, 0(%r31)	# float
	fmul	%f1, %f3, %f1
	fadd	%f0, %f0, %f1
	addis	%r31, %r0, (l.866)@h	# lis
	addi	%r31, %r31, (l.866)@l
	lfs	%f1, 0(%r31)	# float
	fmul	%f1, %f1, %f2
	fsub	%f0, %f0, %f1
	blr
...
#	main program starts
	...
	addi	%r6, %r6, (sqrt.434)@l
	stw	%r6, 0(%r2)
	stw	%r5, 4(%r2)
	addis	%r31, %r0, (l.884)@h	# lis
	addi	%r31, %r31, (l.884)@l
	lfs	%f0, 0(%r31)	# float
	stw	%r2, 0(%r3)
	mfspr	%r31, 8	# mflr
	stw	%r31, 4(%r3)
	...
	addi	%r31, %r31, (l.885)@l
	lfs	%f1, 0(%r31)	# float
	fadd	%f0, %f0, %f1
	addis	%r31, %r0, (l.886)@h	# lis
	addi	%r31, %r31, (l.886)@l
	lfs	%f1, 0(%r31)	# float
	fsub	%f0, %f0, %f1
	addis	%r2, %r0, 15	# lis
	ori	%r2, %r2, 16960
