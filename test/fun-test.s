...
bge_cont.861:
	...
	addi	%r4, %r4, 16
	addis	%r8, %r0, (mul_sub.813)@h	# lis
	addi	%r8, %r8, (mul_sub.813)@l
	stw	%r8, 0(%r29)
	stw	%r7, 8(%r29)
	stw	%r6, 4(%r29)
	addi	%r6, %r0, 0	# li
...
#	main program starts
	or	%r4, %r2, %r4	# mr %r2, %r4
	addi	%r4, %r4, 8
	addis	%r5, %r0, (fun.1.440)@h	# lis
	addi	%r5, %r5, (fun.1.440)@l
	stw	%r5, 0(%r2)
	addi	%r5, %r0, 10	# li
	mfspr	%r31, 8	# mflr
	stw	%r31, 4(%r3)
