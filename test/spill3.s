...
bge_cont.1019:
	...
	addi	%r4, %r4, 16
	addis	%r8, %r0, (mul_sub.963)@h	# lis
	ori	%r8, %r8, (mul_sub.963)@l
	stw	%r8, 0(%r29)
	stw	%r7, 8(%r29)
	stw	%r6, 4(%r29)
	addi	%r6, %r0, 0	# li
...
div_sub.929:
	cmpwi	%cr7, %r7, -1
	bne	%cr7, beq_else.1021
	blr
beq_else.1021:
	srw	%r5, %r8, %r7 # swap
	cmp	%cr7, %r6, %r8
	bgt	%cr7, ble_else.1022
	addi	%r8, %r0, 1	# li
	slw	%r8, %r8, %r7 # swap
	add	%r2, %r8, %r2
	slw	%r6, %r8, %r7 # swap
