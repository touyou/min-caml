...
bge_cont.859:
	...
	addi	%r4, %r4, 16
	addis	%r8, %r0, ha16(mul_sub.808)	# lis
	addi	%r8, %r8, lo16(mul_sub.808)
	stw	%r8, 0(%r29)
	stw	%r7, 8(%r29)
	stw	%r6, 4(%r29)
	addi	%r6, %r0, 0	# li
...
#	main program starts
	or	%r4, %r2, %r4	# mr %r2, %r4
	addi	%r4, %r4, 8
	addis	%r5, %r0, ha16(f.432)	# lis
	addi	%r5, %r5, lo16(f.432)
	stw	%r5, 0(%r2)
	or	%r4, %r29, %r4	# mr %r29, %r4
	addi	%r4, %r4, 8
	addis	%r5, %r0, ha16(g.434)	# lis
	addi	%r5, %r5, lo16(g.434)
	stw	%r5, 0(%r29)
	stw	%r2, 4(%r29)
	addi	%r2, %r0, 456	# li
	mfspr	%r31, 8	# mflr
