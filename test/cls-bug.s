...
bge_cont.880:
	...
	addi	%r4, %r4, 16
	addis	%r8, %r0, (mul_sub.829)@h	# lis
	ori	%r8, %r8, (mul_sub.829)@l
	stw	%r8, 0(%r29)
	stw	%r7, 8(%r29)
	stw	%r6, 4(%r29)
	addi	%r6, %r0, 0	# li
...
#	main program starts
	or	%r4, %r2, %r4	# mr %r2, %r4
	addi	%r4, %r4, 8
	addis	%r5, %r0, (f.443)@h	# lis
	ori	%r5, %r5, (f.443)@l
	stw	%r5, 0(%r2)
	or	%r4, %r29, %r4	# mr %r29, %r4
	addi	%r4, %r4, 8
	addis	%r5, %r0, (g.445)@h	# lis
	ori	%r5, %r5, (g.445)@l
	stw	%r5, 0(%r29)
	stw	%r2, 4(%r29)
	addi	%r2, %r0, 456	# li
