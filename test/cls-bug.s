...
div_sub.774:
	cmpwi	%cr7, %r7, -1
	bne %cr7, beq_else.861
	blr
beq_else.861:
	srw	%r5, %r8, %r7 # swap
	cmp	%cr7, %r6, %r8
	bgt %cr7, ble_else.862
	addi	%r8, %r0, 1	# li
	slw	%r8, %r8, %r7 # swap
	add	%r2, %r8, %r2
	slw	%r6, %r8, %r7 # swap
...
#	main program starts
	or	%r4, %r2, %r4	# mr %r2, %r4
	addi	%r4, %r4, 8
	addis	%r5, %r0, (f.432)@h	# lis
	addi	%r5, %r5, (f.432)@l
	stw	%r5, 0(%r2)
	or	%r4, %r29, %r4	# mr %r29, %r4
	addi	%r4, %r4, 8
	addis	%r5, %r0, (g.434)@h	# lis
	addi	%r5, %r5, (g.434)@l
	stw	%r5, 0(%r29)
	stw	%r2, 4(%r29)
	addi	%r2, %r0, 456	# li
