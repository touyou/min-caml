...
bge_cont.861:
	...
	addi	%r4, %r4, 16
	addis	%r8, %r0, ha16(mul_sub.815)	# lis
	addi	%r8, %r8, lo16(mul_sub.815)
	stw	%r8, 0(%r29)
	stw	%r7, 8(%r29)
	stw	%r6, 4(%r29)
	addi	%r6, %r0, 0	# li
